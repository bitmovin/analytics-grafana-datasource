...
//TODO how to transform into enum? Does it need to be transformed into enum or saving as const is okay?
...
export const getAttributeValues = (list) => Object.values(list);
export const ATTRIBUTE_LIST = Object.values(ATTRIBUTE);
export const AD_ATTRIBUTE_LIST = Object.values(AD_ATTRIBUTE);
export const ORDERBY_ATTRIBUTES_LIST = Object.values(ORDERBY_ATTRIBUTES);
...
export const getAsOptionsList = (list) => {
  return list.map(list, (e) => ({value: e, text: e}));
}
